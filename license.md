...
Welcome! This mod was created by Sergey Pekarchik specifically for NeoForge 1.21.4+.

### Features:
- Fully original textures
- Supports Minecraft 1.21.4 and 1.21.5
- Unique gameplay mechanics (e.g., Burned Paper Block that attracts creepers and repels bees)
...
Добро пожаловать! Этот мод создан специально для NeoForge 1.21.4+.

### Особенности:
- Полностью авторские текстуры
- Поддержка Minecraft 1.21.4 и 1.21.5
- Уникальные игровые механики (например, Сгоревший блок бумаги, привлекающий криперов и отпугивающий пчёл)

### Установка:
- Убедитесь, что у вас установлен Minecraft 1.21.4 или 1.21.5 с NeoForge
