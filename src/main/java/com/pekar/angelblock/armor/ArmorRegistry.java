...
public class ArmorRegistry
{
    ...
    public static final DeferredItem<ModHumanoidArmor> LAPIS_HELMET = registerHumanoidArmor("lapis_helmet", ModArmorMaterial.LAPIS, ArmorItem.Type.HELMET, PlayerArmorType.AQUARITE, ModHumanoidArmor::new);
    public static final DeferredItem<ModHumanoidArmor> LAPIS_HELMET_WITH_NIGHT_VISION = registerHumanoidArmor("lapis_helmet_with_detector", ModArmorMaterial.LAPIS2, ArmorItem.Type.HELMET, PlayerArmorType.AQUARITE,
            (m, et, t, p) -> new ModHumanoidArmor(m, et, t, p).withNightVision());
    public static final DeferredItem<ModHumanoidArmor> LAPIS_CHESTPLATE = registerHumanoidArmor("lapis_chestplate", ModArmorMaterial.LAPIS, ArmorItem.Type.CHESTPLATE, PlayerArmorType.AQUARITE, ModHumanoidArmor::new);
    public static final DeferredItem<ModHumanoidArmor> LAPIS_CHESTPLATE_WITH_STRENGTH = registerHumanoidArmor("lapis_chestplate_with_strength", ModArmorMaterial.LAPIS2, ArmorItem.Type.CHESTPLATE, PlayerArmorType.AQUARITE,
            (m, et, t, p) -> new ModHumanoidArmor(m, et, t, p).withStrengthBooster());
    public static final DeferredItem<ModHumanoidArmor> LAPIS_LEGGINGS = registerHumanoidArmor("lapis_leggings", ModArmorMaterial.LAPIS, ArmorItem.Type.LEGGINGS, PlayerArmorType.AQUARITE, ModHumanoidArmor::new);
    public static final DeferredItem<ModHumanoidArmor> LAPIS_LEGGINGS_WITH_REGENERATOR = registerHumanoidArmor("lapis_leggings_with_regenerator", ModArmorMaterial.LAPIS2, ArmorItem.Type.LEGGINGS, PlayerArmorType.AQUARITE,
            (m, et, t, p) -> new ModHumanoidArmor(m, et, t, p).withHealthRegenerator());
    public static final DeferredItem<ModHumanoidArmor> LAPIS_BOOTS = registerHumanoidArmor("lapis_boots", ModArmorMaterial.LAPIS, ArmorItem.Type.BOOTS, PlayerArmorType.AQUARITE, ModHumanoidArmor::new);
    public static final DeferredItem<ModHumanoidArmor> LAPIS_BOOTS_WITH_SEA_POWER = registerHumanoidArmor("lapis_boots_with_sea_power", ModArmorMaterial.LAPIS2, ArmorItem.Type.BOOTS, PlayerArmorType.AQUARITE,
    ...
    public static final DeferredItem<ModHumanoidArmor> DIAMITHIC_HELMET = registerHumanoidArmor("diamithic_helmet", ModArmorMaterial.DIAMITHIC, ArmorItem.Type.HELMET, PlayerArmorType.DIAMITE, ModHumanoidArmor::new);
    public static final DeferredItem<ModHumanoidArmor> DIAMITHIC_HELMET_WITH_DETECTOR = registerHumanoidArmor("diamithic_helmet_with_detector", ModArmorMaterial.DIAMITHIC2, ArmorItem.Type.HELMET, PlayerArmorType.DIAMITE,
            (m, et, t, p) -> new ModHumanoidArmor(m, et, t, p).withDetector());
    public static final DeferredItem<ModHumanoidArmor> DIAMITHIC_CHESTPLATE = registerHumanoidArmor("diamithic_chestplate", ModArmorMaterial.DIAMITHIC, ArmorItem.Type.CHESTPLATE, PlayerArmorType.DIAMITE, ModHumanoidArmor::new);
    public static final DeferredItem<ModHumanoidArmor> DIAMITHIC_CHESTPLATE_WITH_STRENGTH = registerHumanoidArmor("diamithic_chestplate_with_strength", ModArmorMaterial.DIAMITHIC2, ArmorItem.Type.CHESTPLATE, PlayerArmorType.DIAMITE,
            (m, et, t, p) -> new ModHumanoidArmor(m, et, t, p).withStrengthBooster());
    public static final DeferredItem<ModHumanoidArmor> DIAMITHIC_CHESTPLATE_WITH_LEVITATION = registerHumanoidArmor("diamithic_chestplate_with_levitation", ModArmorMaterial.DIAMITHIC2, ArmorItem.Type.CHESTPLATE, PlayerArmorType.DIAMITE,
            (m, et, t, p) -> new ModHumanoidArmor(m, et, t, p).withSlowFalling());
    public static final DeferredItem<ModHumanoidArmor> DIAMITHIC_CHESTPLATE_WITH_STRENGTH_AND_LEVITATION = registerHumanoidArmor("diamithic_chestplate_with_strength_and_levitation", ModArmorMaterial.DIAMITHIC2, ArmorItem.Type.CHESTPLATE, PlayerArmorType.DIAMITE,
            (m, et, t, p) -> new ModHumanoidArmor(m, et, t, p).withStrengthBooster().withSlowFalling());
    public static final DeferredItem<ModHumanoidArmor> DIAMITHIC_LEGGINGS = registerHumanoidArmor("diamithic_leggings", ModArmorMaterial.DIAMITHIC, ArmorItem.Type.LEGGINGS, PlayerArmorType.DIAMITE, ModHumanoidArmor::new);
    public static final DeferredItem<ModHumanoidArmor> DIAMITHIC_LEGGINGS_WITH_REGENERATOR = registerHumanoidArmor("diamithic_leggings_with_regenerator", ModArmorMaterial.DIAMITHIC2, ArmorItem.Type.LEGGINGS, PlayerArmorType.DIAMITE,
            (m, et, t, p) -> new ModHumanoidArmor(m, et, t, p).withHealthRegenerator());
    public static final DeferredItem<ModHumanoidArmor> DIAMITHIC_BOOTS = registerHumanoidArmor("diamithic_boots", ModArmorMaterial.DIAMITHIC, ArmorItem.Type.BOOTS, PlayerArmorType.DIAMITE, ModHumanoidArmor::new);
    public static final DeferredItem<ModHumanoidArmor> DIAMITHIC_BOOTS_WITH_STRENGTH = registerHumanoidArmor("diamithic_boots_with_strength", ModArmorMaterial.DIAMITHIC2, ArmorItem.Type.BOOTS, PlayerArmorType.DIAMITE,
    ...
    private static DeferredItem<ModHumanoidArmor> registerHumanoidArmor(String name, ModArmorMaterial armorMaterial, ArmorItem.Type armorSlotType,
                                                                        PropertyDispatch.TriFunction<ModArmorMaterial, ArmorItem.Type, Item.Properties, ModHumanoidArmor> armorConstructor)
    {
        return ITEMS.register(name, () -> armorConstructor.apply(armorMaterial, armorSlotType, new Item.Properties()));
    }

    private static DeferredItem<ModHumanoidArmor> registerHumanoidArmor(String name, ModArmorMaterial armorMaterial, ArmorItem.Type armorSlotType, PlayerArmorType armorType,
                                                                        PropertyDispatch.QuadFunction<ModArmorMaterial, ArmorItem.Type, PlayerArmorType, Item.Properties, ModHumanoidArmor> armorConstructor)
    {
        return ITEMS.register(name, () -> armorConstructor.apply(armorMaterial, armorSlotType, armorType, new Item.Properties()));
    }
    ...
    private static <T extends ModArmor> DeferredItem<T> registerAnimalArmor(String name, ModArmorMaterial armorMaterial, AnimalArmorType armorType,
                                                                            PropertyDispatch.TriFunction<ModArmorMaterial, AnimalArmorType, Item.Properties, T> armorConstructor)
    {
