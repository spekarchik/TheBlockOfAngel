...
public class ElderGuardianEyeEffect extends MobEffect
{
    ...
    public boolean applyEffectTick(LivingEntity entity, int amplifier)
    {
        ...
        var nightVisionEffectInstance = new ModMobEffectInstance(MobEffects.NIGHT_VISION, MobEffectInstance.INFINITE_DURATION, 0, false, false, false, true);
