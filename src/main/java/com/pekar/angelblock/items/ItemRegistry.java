...
public class ItemRegistry
{
    ...
    public static final DeferredItem<Item> IRON_ARMOR_UPGRADE_KIT = Main.ITEMS.registerItem("iron_armor_upgrade_kit", IronArmorUpgradeKit::new);
    ...
    public static final DeferredItem<Item> IRON_TOOL_UPGRADE_KIT = Main.ITEMS.registerItem("iron_tool_upgrade_kit", IronToolUpgradeKit::new);
