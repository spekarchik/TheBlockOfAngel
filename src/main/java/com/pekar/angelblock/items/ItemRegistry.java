...
public class ItemRegistry
{
    ...
    public static final DeferredItem<Item> RENDELITHIC_POWDER = Main.ITEMS.registerItem("rendelithic_powder", ModItem::new);
    public static final DeferredItem<Item> DIAMITHIC_POWDER = Main.ITEMS.registerItem("diamithic_powder", ModItem::new);
    ...
    public static final DeferredItem<Item> SUPER_POWDER = Main.ITEMS.registerItem("super_powder", ModItem::new);
    public static final DeferredItem<Item> FLYING_POWDER = Main.ITEMS.registerItem("flying_powder", ModItem::new);

    public static final DeferredItem<Item> RENDELITHIC_INGOT = Main.ITEMS.registerItem("rendelithic_ingot", ModItem::new);
    public static final DeferredItem<Item> DIAMITHIC_INGOT = Main.ITEMS.registerItem("diamithic_ingot", ModItem::new);
    ...
    public static final DeferredItem<Item> SUPER_INGOT = Main.ITEMS.registerItem("super_ingot", ModItem::new);
    public static final DeferredItem<Item> FLYING_INGOT = Main.ITEMS.registerItem("flying_ingot", ModItem::new);

    public static final DeferredItem<Item> RENDELITHIC_PLATE = Main.ITEMS.registerItem("rendelithic_plate", ModItem::new);
    public static final DeferredItem<Item> DIAMITHIC_PLATE = Main.ITEMS.registerItem("diamithic_plate", ModItem::new);
