...
public class ItemRegistry
{
    ...
    public static final TagKey<Item> BAMBOO_TAG = TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Main.MODID, "bamboo_tag"));
    public static final TagKey<Item> DIAMOND_ARMOR_TAG = TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Main.MODID, "diamond_armor"));
    public static final TagKey<Item> NETHERITE_ARMOR_TAG = TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Main.MODID, "netherite_armor"));
    public static final TagKey<Item> DIAMOND_TOOL_TAG = TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Main.MODID, "diamond_tool"));
    public static final TagKey<Item> NETHERITE_TOOL_TAG = TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Main.MODID, "netherite_tool"));
    ...
    public static final TagKey<Item> RODS_MODIFIED_BY_ROD_SENSOR = TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Main.MODID, "rods_modified_by_rod_sensor"));
    ...
    public static final DeferredItem<Item> RENDELITHIC_PLATE = Main.ITEMS.registerItem("rendelithic_plate", ModItem::new, Item.Properties::fireResistant);
    public static final DeferredItem<Item> DIAMITHIC_PLATE = Main.ITEMS.registerItem("diamithic_plate", ModItem::new, Item.Properties::fireResistant);
    ...
    public static final DeferredItem<Item> SUPER_PLATE = Main.ITEMS.registerItem("super_plate", ModItem::new, Item.Properties::fireResistant);
    ...
    public static final DeferredItem<Item> HORSE_ARMOR_HANDBOOK = Main.ITEMS.registerItem("horse_armor_handbook", AnimalArmorHandbook::new, p -> p.rarity(Rarity.UNCOMMON));
    public static final DeferredItem<Item> WOLF_ARMOR_HANDBOOK = Main.ITEMS.registerItem("wolf_armor_handbook", AnimalArmorHandbook::new, p -> p.rarity(Rarity.UNCOMMON));
    public static final DeferredItem<Item> NAUTILUS_ARMOR_HANDBOOK = Main.ITEMS.registerItem("nautilus_armor_handbook", AnimalArmorHandbook::new, p -> p.rarity(Rarity.UNCOMMON));
